...
```{r}
xDispConstTest <- readRDS(file.path(getwd(), "Optimization", "EDispersionMinConstantTest_gloggest2018-12-28---08-55"))
```
...
```{r}
xDispNoRFVarTest <- readRDS(file.path(getwd(), "Optimization", "EDispersionNoRFMinVaryingTest_gloggest2018-12-28---09-00"))
```
...
```{r}
xHerfVarTest <- readRDS(file.path(getwd(), "Optimization", "EHerfMinVaryingTest_gloggest2018-12-28---09-07"))
```
...
```{r}
xDispVarEval <- readRDS(file.path(getwd(), "Optimization", "EDispersionMinVaryingEval_gloggest2018-12-28---09-13"))
```
...
```{r}
xDispNoRFVarEval <- readRDS(file.path(getwd(), "Optimization", "EDispersionNoRFMinVaryingEval_gloggest2018-12-28---10-05"))
```
...
```{r}
xHerfVarEval <- readRDS(file.path(getwd(), "Optimization", "EHerfMinVaryingEval_gloggest2018-12-28---09-13"))
```
...
```{r}
xHerfNoRFVarEval <- readRDS(file.path(getwd(), "Optimization", "EHerfNoRFMinVaryingEval_gloggest2018-12-28---09-13"))
```
